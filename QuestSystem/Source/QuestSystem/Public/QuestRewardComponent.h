...
public:
	...
	/**
	 * Find a numeric property and add a value to it
	 * Searches owner actor and all components
	 */
	UFUNCTION(BlueprintCallable, Category = "Rewards")
	 ...
	 * Automatically finds the inventory component based on config
	 */
	UFUNCTION(BlueprintCallable, Category = "Rewards")
	...
	/**
	 * Initialize auto-detection - scans the actor for available properties
	 * Called automatically on BeginPlay if bAutoDetectCommonStats is true
	 */
	UFUNCTION(BlueprintCallable, Category = "Rewards")
