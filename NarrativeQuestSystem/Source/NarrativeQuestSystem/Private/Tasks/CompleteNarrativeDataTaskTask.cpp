...
#include "Tasks/CompleteNarrativeDataTaskTask.h"
#include "NarrativeComponent.h"

UCompleteNarrativeDataTaskTask::UCompleteNarrativeDataTaskTask()
{
	bRetroactive = false;
	StartingCount = 0;
...
void UCompleteNarrativeDataTaskTask::BeginTask_Implementation()
{
...
void UCompleteNarrativeDataTaskTask::TaskTick_Implementation()
{
...
FText UCompleteNarrativeDataTaskTask::GetTaskDescription_Implementation() const
{
...
FString UCompleteNarrativeDataTaskTask::GetTaskNodeDescription_Implementation() const
{
	if (!Argument.IsEmpty())
	{
