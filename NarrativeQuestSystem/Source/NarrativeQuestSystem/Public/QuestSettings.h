...
/**
 * Settings for the Narrative Quest System
 */
UCLASS(config = Game, defaultconfig, meta = (DisplayName = "Narrative Quest System"))
class NARRATIVEQUESTSYSTEM_API UQuestSettings : public UDeveloperSettings
{
	GENERATED_BODY()
