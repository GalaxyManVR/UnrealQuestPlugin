...
class NARRATIVEQUESTSYSTEM_API UQuestBranch : public UObject
{
	GENERATED_BODY()
...
public:
	...
	// FIXED: Added Category to these properties
	...
	void ActivateBranch(class UNarrativeComponent* NarrativeComp);
...
protected:
	/** Cached Narrative Component for checking task completion */
	UPROPERTY()
	TObjectPtr<class UNarrativeComponent> CachedNarrativeComp;
};