...
class NARRATIVEQUESTSYSTEM_API UQuest : public UObject
{
	GENERATED_BODY()
...
public:
	...
	/** Owner */
	UPROPERTY(BlueprintReadOnly, Category = "Quest")
	TObjectPtr<UNarrativeComponent> OwningComp;
	...
	/** Lifecycle Functions */
	void Initialize(UNarrativeComponent* InOwningComp);
#if WITH_EDITOR
	...
	// ============================================================================
	// NEW: Editor Compilation Support
	// ============================================================================
	...
	// Add these to the public section of UQuest class in Quest.h
...
private:
	// ============================================================================
	// NEW: Private member for PreSave callback
	// ============================================================================
