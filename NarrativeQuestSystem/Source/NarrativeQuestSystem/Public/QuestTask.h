...
class NARRATIVEQUESTSYSTEM_API UQuestTask : public UObject
{
	GENERATED_BODY()
...
public:
	...
	/** Cached narrative component */
	UPROPERTY(BlueprintReadOnly, Category = "Task")
	TObjectPtr<UNarrativeComponent> OwningComp;

	/** Task Lifecycle - Base implementations */
	virtual void BeginTask(UNarrativeComponent* NarrativeComp);
	virtual void EndTask();
	virtual void UpdateTaskProgress(UNarrativeComponent* NarrativeComp);
