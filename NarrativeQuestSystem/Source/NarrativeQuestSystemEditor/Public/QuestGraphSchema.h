 ...
 */
UCLASS()
class NARRATIVEQUESTSYSTEMEDITOR_API UQuestGraphSchema : public UEdGraphSchema
{
	GENERATED_BODY()
...
USTRUCT()
struct NARRATIVEQUESTSYSTEMEDITOR_API FQuestGraphSchemaAction_NewState : public FEdGraphSchemaAction
{
	GENERATED_BODY()
...
USTRUCT()
struct NARRATIVEQUESTSYSTEMEDITOR_API FQuestGraphSchemaAction_NewTask : public FEdGraphSchemaAction
{
	GENERATED_BODY()
